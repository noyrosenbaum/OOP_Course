...
public class TestUndoableStringBuilder {
    ...
    public void testStrConstructor(){
        UndoableStringBuilder usbStrConst = new UndoableStringBuilder("to be or not to be");
    ...
    public void testAppend(){
        UndoableStringBuilder usbAppend = new UndoableStringBuilder("to be or not to be");
        assertEquals("to be or not to be", usbAppend.toString());
        usbAppend.append("to be or not to be");
        usbAppend.append("to be or not to be");
        assertEquals("to be or not to beto be or not to beto be or not to be",usbAppend.toString());
    }
    @Test
    public void testAppendsec(){
        UndoableStringBuilder usbAppendsec = new UndoableStringBuilder("Let's have fun :)");
        ...
        assertEquals("Let's have fun :) let's have fun :)",usbAppendsec.toString());
    }

    @Test
    public void testDelete(){
        UndoableStringBuilder usbDel = new UndoableStringBuilder("Let's have fun :)");
    ...
    public void testDeleteSec(){
        UndoableStringBuilder usbDelSec = new UndoableStringBuilder("Let's have fun :)");
    ...
    public void testInsert(){
        UndoableStringBuilder usbIns = new UndoableStringBuilder("Let's have fun :)");
        ...
        assertEquals("Let's get some ice cream And Let's have fun :)", usbIns.toString());
    }
    @Test
    public void testInsertSec(){
        UndoableStringBuilder usbInsSec = new UndoableStringBuilder("Let's have fun :)");
    ...
    public void testReplace(){
        UndoableStringBuilder usbRpc = new UndoableStringBuilder("Let's have fun :)");
    ...
    public void testReplaceSec(){
        UndoableStringBuilder usbRpcSec = new UndoableStringBuilder("Don't Worry Be Happy :)");
        usbRpcSec.replace(usbRpcSec.toString().length()-2, usbRpcSec.toString().length()+3, "!!");
        assertEquals("Don't Worry Be Happy !!", usbRpcSec.toString());
    }

    @Test
    public void testReverse(){
        UndoableStringBuilder usbRev = new UndoableStringBuilder("Is this the end of our tests?");
    ...
    public void testMain(){
        UndoableStringBuilder usbMain = new UndoableStringBuilder("to be or not to be");

        assertEquals("to be or not to be", usbMain.toString());
        usbMain.replace(3, 5, "eat") ;
        assertEquals("to eat or not to be",usbMain.toString());
        usbMain.replace(17, 19, "eat") ;
        assertEquals("to eat or not to eat",usbMain.toString());
        usbMain.reverse();

        assertEquals("tae ot ton ro tae ot",usbMain.toString());
        usbMain.undo();
        assertEquals("to eat or not to eat",usbMain.toString());
        usbMain.undo();
        assertEquals("to eat or not to be",usbMain.toString());
    ...
    public void testUndo(){
        UndoableStringBuilder usbUndo = new UndoableStringBuilder("to be or not to be");
    ...
    public void testUndoSec(){
        UndoableStringBuilder usbUndoSec = new UndoableStringBuilder("This is our last TEST ForReal! :)");
        usbUndoSec.append(" Did you have fun with us?");
        assertEquals("This is our last TEST ForReal! :) Did you have fun with us?", usbUndoSec.toString());
        usbUndoSec.undo();
